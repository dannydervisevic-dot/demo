...
export function UserTypesClient({ initialUserTypes }: { initialUserTypes: UserType[] }) {
        ...
        <div className="container mx-auto p-6 max-w-7xl">
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-muted-foreground mt-1">Manage different types of users in the system</p>
            </div>
